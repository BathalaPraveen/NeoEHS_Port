                                    ...
                                    <div class="row g-3 px-4 pt-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 form-input">
                                                ...
                                                <div>{{ getDesignationName($users->designation) }}
                                                </div>
                                            </div>
                                                        ...
                                                        <tbody id="chemicaldetails">
                                                            @foreach ($chemicallistDetails as $index => $chemical)
                                                                <tr class="chemical_list">
                                                                    ...
                                                                    <td>--</td> {{-- Placeholder for Action if needed --}}
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
                                                    </table>
                                        ...
                                        @if (
                                            ...
                                            <form method="POST">
                                                ...
                                                <div class="row g-3 px-4 pt-4">
                                                    ...
                                                    <div class="col-md-4 form-input">
                                                        <label for="approved_by_id" class="form-label bold">Name</label>
                                        ...
                                        @if ($chemicalDetails->chemical_status == CHEMICAL_SUPERVIOR_PENDING)
                                            <div class="card-header card-header-inner ">
                                                <h6 class="text-white"> Supervior Approval</h6>
                                            </div>

                                            <form method="POST"
                                                action="{{ admin_url('chemical/chemical/supervisor/submit') }}"
                                                id="supervisor_approval">
                                                <input type="hidden" name="id"
                                                    value="{{ encryptId($chemicalDetails->id) }}">
                                                @csrf
                                                ...
                                                <div class="row g-3 px-4 pt-4">
                                                    ...
                                                    <div class="col-md-4 form-input">
                                                        <label for="approved_by_id" class="form-label bold">Name</label>
                                                        <input type="text" class="form-control" id="approved_by_id"
                                                            value="{{ Auth::user()->name }}" readonly>
                                                        <div>
                                                            <input type="hidden" name="approved_by_id"
                                                                value="{{ encryptId(Auth::user()->id) }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4 form-input">
                                                        <label for="reporter_designation"
                                                    ...
                                                    <div class="col-md-4 form-input">
                                                        <label for="approved_by_date" class="form-label bold">Date
                                                            ...
                                                            Time</label>
                                                        <div></div>
                                                        <input type="text" name="approved_by_date"
                                                            class="form-control" id="approved_by_date"
                                                    ...
                                                    <div class="col-md-12 form-input">
                                                        <label for="approved_by_remarks"
                                                            class="form-label bold">Remarks</label>
                                                        <div>
                                                            <textarea class="form-control" name="approved_by_remarks" id="remarks" rows="3"></textarea>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row card-bottom">
                                                    <div class="col-12 mt-2 mb-3">
                                                        ...
                                                        <button type="submit" class="btn btn-danger " name="action"
                                                            value="Reject" data-bs-toggle="tooltip"
                                                            title="Reject">Reject</button>
                                                        <button class="btn btn-primary " type="submit" name="action"
                                                            value="Approve" data-bs-toggle="tooltip"
                                        ...
                                        @if ($chemicalDetails->chemical_status == CHEMICAL_ACKNOWLEDGMENT_PENDING)
                                            <div class="card-header card-header-inner ">
                                                <h6 class="text-white">SECTION D : Review and Endorsement</h6>
                                            </div>

                                            <form method="POST"
                                                action="{{ admin_url('chemical/chemical/hod/submit') }}">
                                                <input type="hidden" name="id"
                                                    value="{{ encryptId($chemicalDetails->id) }}">
                                                @csrf
                                                ...
                                                <div class="row g-3 px-4 pt-4">
                                                    ...
                                                    <div class="col-md-12 form-input ">
                                                        <p style="font-size: 16px;">
                                                            I <strong> <u> {{ Auth::user()->name }} </u> </strong> hereby
                                                            declare that this
                                                            chemical register shall be accessible to all employees
                                                            at
                                                    ...
                                                    <div class="col-md-4 form-input">
                                                        <label for="acknowledged_by" class="form-label bold">Name</label>
                                                        <input type="text" class="form-control" id="acknowledged_by"
                                                            value="{{ Auth::user()->name }}" readonly>
                                                        <input type="hidden" name="acknowledged_by"
                                                            value="{{ encryptId(Auth::user()->id) }}">
                                                    ...
                                                    <div class="col-md-4 form-input">
                                                        <label for="reporter_designation"
                                                            class="form-label bold">Designation</label>
                                                        <input type="" class="form-control"
                                                            value="{{ Auth::user()->user_designation_name }}" readonly>
                                                    </div>

                                                    <div class="col-md-4 form-input">
                                                        <label for="acknowledged_at" class="form-label bold">Date
                                                            &
                                                            Time</label>

                                                        <input type="text" name="acknowledged_at" class="form-control"
                                                            id="acknowledged_at" value="{{ todayDateTime() }}" readonly>
                                                ...
                                                <div class="row card-bottom">
                                                    <div class="col-12 mt-2 mb-3">
                                                        ...
                                                        <button class="btn btn-primary " type="submit" name="approve"
                                                            value="Submit" data-bs-toggle="tooltip"
