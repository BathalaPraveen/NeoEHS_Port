            ...
            <div class="card page-breadcrumb  d-sm-flex align-items-center mb-3">
                ...
                <div class="ms-auto button-action">
                    <div class="btn-group btn-skew">
                        <a class="btn btn-outline-primary" href="{{ admin_url('home') }}"> Back</a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12 mx-auto">
                    <div class="card border radius-10 mt-2">
                        <div class="card-body">
                            ...
                            <form id="profileEdit" class="forms-sample" method="post"
                                action="{{ admin_url('profileUpdate') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-3 ">
                                        <div class="col-4 form-group">
                                            ...
                                            <input type="text" class="form-control rounded-pill" id="user_name"
                                                name="user_name" value="{{ $user_detail['name'] }}" placeholder="User Name">
                                            @error('user_name')
                                        ...
                                        <div class="col-4 form-group">
                                            ...
                                            <input type="text" class="form-control rounded-pill" name="mobile"
                                                value="{{ $user_detail['mobile'] }}" placeholder="Contact Number">
                                            @error('mobile')
                                        ...
                                        <div class="col-4 form-group">
                                            ...
                                            <select class="form-select mb-3 rounded-pill" name="country"
                                                aria-label="Default select example">
                                                @foreach ($country_detail as $country)
                                                    <option @if ($user_detail['country'] == $country['id']) selected @endif
                                        ...
                                        <div class="col-4 form-group">
                                            ...
                                            <input type="text" class="form-control rounded-pill" name="email"
                                                value="{{ $user_detail['email'] }}" placeholder="Email" readonly>
                                            @error('email')
                                        ...
                                        <div class="col-4 form-group">
                                            ...
                                            <input class="form-control" type="file" name="profile_image"
                                                ...
                                                value="{{ getProfileImage($user_detail['profile_image']) }}"
