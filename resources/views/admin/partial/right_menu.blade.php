...
<aside class="nav-customizer" id="shopping-cart">
    <div class="nav-customizer-body">
        <div class="rounded-top d-flex p-30 bg-white pb-3 align-items-center">
            <h3 class="card-title mb-0">Notification</h3>
            <div class="ms-auto">
            ...
            <ul class="list-style-none">
                <li class="py-4 border-bottom">
                    <div class="d-flex align-items-center">
                        <div>
                            <img src="{{ asset('public/assets/images/product/s-prd1.jpg') }}" class="btn-rounded-lg"
                                alt="product" />
                        </div>
                        <div class="ms-3 ps-1">
                                ...
                                <div class="shopping-widget ms-2">
                                    <div class="form-group mb-0 pt-1">
                                        <input type="text" value="1" name="qtyspin1" id="qtyspin1"
                                            ...
                                            class="form-control text-center border-0 bg-transparent counter fs-4 text-dark font-weight-medium " />
                                    </div>
                                    <div class="decrease-btn">
                                        <button type="button"
                                            class=" btn btn-sm btn-light-success text-success decrease waves-effect waves-light ">
                                            <i data-feather="minus" class="feather-xs"></i>
                                        </button>
                                    </div>
                                    <div class="increase-btn">
                                        <button type="button"
                                            class="btn btn-sm btn-light-success text-success increase waves-effect waves-light">
                ...
                <li class="py-4 border-bottom">
                    <div class="d-flex align-items-center">
                        <div>
                            <img src="{{ asset('public/assets/images/product/s-prd2.jpg') }}" class="btn-rounded-lg"
                                alt="product" />
                        </div>
                        <div class="ms-3 ps-1">
                            <h5 class="mb-0">Supreme toys cooker</h5>
                ...
                <li class="py-4 border-bottom">
                    <div class="d-flex align-items-center">
                        <div>
                            <img src="{{ asset('public/assets/images/product/s-prd3.jpg') }}" class="btn-rounded-lg"
                                alt="product" />
                        </div>
                        <div class="ms-3 ps-1">
                            <h5 class="mb-0">Supreme toys cooker</h5>
                ...
                <li class="py-4 border-bottom">
                    <div class="d-flex align-items-center">
                        <div>
                            <img src="{{ asset('public/assets/images/product/s-prd4.jpg') }}" class="btn-rounded-lg"
                                alt="product" />
                        </div>
                        <div class="ms-3 ps-1">
                            <h5 class="mb-0">Supreme toys cooker</h5>
                        ...
                        <div class="message-center chat-scroll position-relative">
                            <a href="javascript:void(0)"
                                ...
                                <div class="w-75 d-inline-block v-middle ps-3">
                                    ...
                                    <span class="fs-2 text-nowrap d-block text-muted text-truncate">Just
                            ...
                            <a href="javascript:void(0)"
                                ...
                                data-user-id="2">
                                <span class="user-img position-relative d-inline-block">
                                    <img src="{{ asset('public/assets/images/users/2.jpg') }}" alt="user"
                                        class="rounded-circle w-100" />
                                    <span class="profile-status rounded-circle busy"></span>
                                </span>
                                <div class="w-75 d-inline-block v-middle ps-3">
                                    <h5 class="message-title mb-0 mt-1">Sonu Nigam</h5>
                                    <span class=" fs-2 text-nowrap d-block text-muted text-truncate ">I've
                            ...
                            <a href="javascript:void(0)"
                                ...
                                data-user-id="3">
                                <span class="user-img position-relative d-inline-block">
                                    <img src="{{ asset('public/assets/images/users/3.jpg') }}" alt="user"
                                        class="rounded-circle w-100" />
                                    <span class="profile-status rounded-circle away"></span>
                                </span>
                                <div class="w-75 d-inline-block v-middle ps-3">
                                    <h5 class="message-title mb-0 mt-1">Arijit Sinh</h5>
                                    <span class="fs-2 text-nowrap d-block text-muted text-truncate ">I
                                        am a singer!</span>
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <span class="user-img position-relative d-inline-block">
                                    <img src="{{ asset('public/assets/images/users/4.jpg') }}" alt="user"
                                        class="rounded-circle w-100" />
                            ...
                            <a href="javascript:void(0)"
                                ...
                                data-user-id="5">
                                <span class="user-img position-relative d-inline-block">
                                    <img src="{{ asset('public/assets/images/users/5.jpg') }}" alt="user"
                                        class="rounded-circle w-100" />
                                    <span class="profile-status rounded-circle offline"></span>
                                </span>
                                <div class="w-75 d-inline-block v-middle ps-3">
                            ...
                            <a href="javascript:void(0)"
                                ...
                                data-user-id="6">
                                <span class="user-img position-relative d-inline-block">
                                    <img src="{{ asset('public/assets/images/users/6.jpg') }}" alt="user"
                                        class="rounded-circle w-100" />
                                    <span class="profile-status rounded-circle offline"></span>
                                </span>
                                <div class="w-75 d-inline-block v-middle ps-3">
                            ...
                            <a href="javascript:void(0)"
                                ...
                                <span class="user-img position-relative d-inline-block">
                                    <img src="{{ asset('public/assets/images/users/7.jpg') }}" alt="user"
                                        class="rounded-circle w-100" />
                                    <span class="profile-status rounded-circle offline"></span>
                                </span>
                                <div class="w-75 d-inline-block v-middle ps-3">
                            ...
                            <a href="javascript:void(0)"
                                ...
                                data-user-id="8">
                                <span class="user-img position-relative d-inline-block">
                                    <img src="{{ asset('public/assets/images/users/8.jpg') }}" alt="user"
                                        class="rounded-circle w-100" />
                                    <span class="profile-status rounded-circle offline"></span>
                                </span>
                                <div class="w-75 d-inline-block v-middle ps-3">
            ...
            <div class="tab-pane fade p-3" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                ...
                <div class="steamline">
                    ...
                    <div class="sl-item">
                        <div class="sl-left">
                            <img class="rounded-circle" alt="user"
                                src="{{ asset('public/assets/images/users/2.jpg') }}" />
                        </div>
                        <div class="sl-right">
                            <div class="font-weight-medium">
                    ...
                    <div class="sl-item">
                        <div class="sl-left">
                            <img class="rounded-circle" alt="user"
                                src="{{ asset('public/assets/images/users/4.jpg') }}" />
                        </div>
                        <div class="sl-right">
                            <div class="font-weight-medium">
                                Go to the Doctor <span class="sl-date">5 minutes ago</span>
                    ...
                    <div class="sl-item">
                        <div class="sl-left">
                            <img class="rounded-circle" alt="user"
                                src="{{ asset('public/assets/images/users/6.jpg') }}" />
                        </div>
                        <div class="sl-right">
                            <div>
                                <a href="javascript:void(0)">Stephen</a>
