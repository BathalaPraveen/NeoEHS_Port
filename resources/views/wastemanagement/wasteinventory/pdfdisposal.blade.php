                ...
                @foreach ($content as $key => $value)
                    <tr>
                        ...
                        <td style='padding: 7px;border: 0.5px solid'>
                            {{ $value->wastetype_name }}
                        </td>
                        <td style='padding: 7px;border: 0.5px solid'>
                            {{ $value->wastetype_id }}
                        </td>
                        <td style='padding: 7px;border: 0.5px solid'>
                            {{ Displaydateformat($value->generation_date) }}
                        </td>
                        <td style='padding: 7px;border: 0.5px solid'>
                            {{ getItemName($value->location) }}
                        </td>
                        ...
                        <td style='padding: 7px;border: 0.5px solid'>
                            {{ getpackageName($value->type_of_packing) }}
                        </td>
                        <td style='padding: 7px;border: 0.5px solid'>
                            {{ $value->estimated_weight }}
                        </td>
                        <td style='padding: 7px;border: 0.5px solid'>
                            {{  Displaydateformat($value->entry_date) }}
                        </td>
                        <td style='padding: 7px;border: 0.5px solid'>
                            {{ $value->entry_qty }}
                        </td>
