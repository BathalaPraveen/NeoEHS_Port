...
@section('title', 'Waste Inventory List')
                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Waste Inventory List</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-lg-flex align-items-center gap-3">
                        ...
                        <div class="position-relative">
                            <h5 class="card-title">Waste Inventory List</h5>
                        </div>
                        <div class="ms-auto">
                            ...
                            <a href="{{ admin_url('wastemanagement/' . $companyname . '/wasteinventory/disposal/list') }}"
                                class="btn btn-primary">
                                Disposal
                            </a>
                            <a href="{{ admin_url('wastemanagement/' . $companyname . '/wasteinventory/add/list') }}"
                                class="btn btn-primary">
                                New
                            </a>
                        </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.datatable-list').DataTable({
                ...
                "ordering": false,
                ajax: {
                    url: "{{ admin_url('wastemanagement/' . $companyname . '/wasteinventory/list') }}",
                    type: 'POST',
                    headers: {
                        ...
                        buttons: [{
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('wastemanagement/' . $companyname . '/wasteinventory/export/pdf') }}" +
                                        '?search=' + searchValue +
                                        '&wastetype=' + wastetype ;
                                }
                            },
                            {
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('wastemanagement/' . $companyname . '/wasteinventory/export/excel') }}" +
                                        '?search=' + searchValue +
                                        '&wastetype=' + wastetype ;
                                }
                            },
