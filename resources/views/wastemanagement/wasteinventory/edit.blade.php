                ...
                <div>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Waste Edit</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Waste Edit</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            <form id="waste_edit_form" novalidate method="POST" enctype="multipart/form-data"
                                action="{{ admin_url('wastemanagement/waste/edit/submit') }}">
                                <input type="hidden" value="{{ encryptId($wasteDetails->id) }}" name="id">
                                    ...
                                    <div>
                                                ...
                                                <div class="col-md-4 form-input">
                                                    ...
                                                    <select name="company" id="company" class="form-control select2">
                                                        ...
                                                        @foreach ($companyList as $company)
                                                            <option @if ($wasteDetails->company_id == $company->id) selected @endif
                                            ...
                                            <div class="col-md-4 form-input">
                                                ...
                                                <select name="location" id="location" class="form-control select2">
                                                    ...
                                                    @foreach ($locationList as $location)
                                                        <option @if ($wasteDetails->location_id == $location->id) selected @endif
                                                    ...
                                                    <div class="waste_list" id="">
                                                        <div class="row">
                                                            <div class="col-md-3 form-input">
                                                                ...
                                                                <select name="waste[{{ $i }}][wastetype]"
                                                                    id="wastetype_{{ $i }}"
                                                                    data-error="Please select Name of Waste"
                                                                    class="form-control select2 validate-select-required wastetype"
                                                                    style="width:100%">
                                                                    <option data-typeid="" value="">Please Select
                                                                        Waste
                                                                    </option>
                                                                    @foreach ($wastetypeList as $wastetype)
                                                                        <option
                                                                            @if ($wastelist->waste_type == $wastetype->id) selected @endif
                                                                            data-typeid="{{ $wastetype->wastetype_id }}"
                                                            ...
                                                            <div class="col-md-3 form-input">
                                                                ...
                                                                <input type="text"
                                                                    name="waste[{{ $i }}][wastetypeid]" readonly
                                                                    class="form-control validate-input-required"
                                                                    data-error="" id="waste_type_id_{{ $i }}"
                                                                    value="{{ $wastelist->waste_type_id }}">
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="d-lg-flex align-items-center gap-3">
                                                                    ...
                                                                    <div class="ms-auto">
                                                                        <button
                                                                            class="btn btn-primary btn-sm previousaddmore"
                                                                    ...
                                                                    <div class="previousrecord_list">
                                                                        <div class="row recordrow">
                                                                            <div class="col-md-3 form-input">
                                                                                ...
                                                                                <div class="input-group ">
                                                                                    <input type="text"
                                                                                        ...
                                                                                        data-error=""
                                                                                        name="waste[{{ $i }}][previous][{{ $j }}][date]"
                                                                                        readonly
                                                                                        id="waste_{{ $i }}_previous_date_{{ $j }}"
                                                                                        required=""
                                                                                        value="{{ $previousrecord->date }}">
                                                                                    <div
                                                                            ...
                                                                            <div class="col-md-3 form-input">
                                                                                ...
                                                                                <input type="text"
                                                                                    name="waste[{{ $i }}][previous][{{ $j }}][qty]"
                                                                                    class="form-control inputqty previousqty validate-input-required"
                                                                                    data-error="" data-type="previous"
                                                                                    id="waste_{{ $i }}_previous_qty_{{ $j }}"
                                                                                    value="{{ $previousrecord->qty }}">
                                                                            </div>
                                                                            <div class="col-md-3 form-input">
                                                                                <label>Disposal Type</label>
                                                                                <select
                                                                                    name="waste[{{ $i }}][previous][{{ $j }}][uom]"
                                                                                    id="waste_{{ $i }}_previous_uom_{{ $j }}"
                                                                                    class="form-control select2 inputuom previousuom validate-select-required"
                                                                                    data-error="" data-type="previous">
                                                                                    <option value="">Select Disposal
                                                                                        type
                                                                                    </option>
                                                                                    @foreach ($disposaltypeList as $disposaltype)
                                                                                        <option
                                                                                            @if ($previousrecord->uom == $disposaltype->id) selected @endif
                                                                                            value="{{ $disposaltype->id }}">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="row recordrow">
                                                                <div class="col-md-3 form-input">
                                                                    ...
                                                                    <div class="input-group ">
                                                                        <input type="text"
                                                                            class="form-control todaymaxdatepicker validate-input-required"
                                                                            data-error=""
                                                                            value="{{ $wastelist->disposal_date }}"
                                                                            name="waste[{{ $i }}][current][1][date]"
                                                                            readonly
                                                                            id="waste_{{ $i }}_current_date_1"
                                                                            required="">
                                                                ...
                                                                <div class="col-md-3 form-input">
                                                                    <label>Quantity</label>
                                                                    <input type="text"
                                                                        name="waste[{{ $i }}][current][1][qty]"
                                                                        value="{{ $wastelist->total_disposal }}"
                                                                        data-error="" data-type="current"
                                                                        class="form-control inputqty validate-input-required"
                                                                        id="waste_{{ $i }}_current_qty_1">
                                                                </div>
                                                                <div class="col-md-3 form-input">
                                                                    <label>Disposal Type</label>
                                                                    <select
                                                                        name="waste[{{ $i }}][current][1][uom]"
                                                                        data-type="current"
                                                                        id="waste_{{ $i }}_current_uom_1"
                                                                        ...
                                                                        @foreach ($disposaltypeList as $disposaltype)
                                                                            <option
                                                                                @if ($wastelist->disposal_type == $disposaltype->id) selected @endif
                                                                                value="{{ $disposaltype->id }}">
                                                                                {{ $disposaltype->disposaltype_name }}
                                                                            </option>
                                                                        @endforeach
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="row recordrow">
                                                                ...
                                                                <div class="col-md-3 form-input">
                                                                    <label>Quantity</label>
                                                                    <input type="text"
                                                                        name="waste[{{ $i }}][afterdisposal][1][qty]"
                                                                        data-type="afterdisposal"
                                                                        class="form-control inputqty validate-input-required"
                                                                        data-error=""
                                                                        value="{{ $wastelist->balance_waste }}"
                                                                        id="waste_{{ $i }}_afterdisposal_qty_1">
                                                                </div>
                                                                <div class="col-md-3 form-input">
                                                                    <label>Disposal Type</label>
                                                                    <select
                                                                        name="waste[{{ $i }}][afterdisposal][1][uom]"
                                                                        data-type="afterdisposal"
                                                                        id="waste_{{ $i }}_afterdisposal_uom_1"
                                                                        class="form-control select2 inputuom validate-select-required"
                                                                        data-error="">
                                                                        <option value="">Select Disposal type
                                                                        </option>
                                                                        @foreach ($disposaltypeList as $disposaltype)
                                                                            <option
                                                                                @if ($wastelist->balance_waste_disposal_type == $disposaltype->id) selected @endif
                                                                                value="{{ $disposaltype->id }}">
                                                                                {{ $disposaltype->disposaltype_name }}
                                                                            </option>
                                                                        @endforeach
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="d-lg-flex align-items-center gap-3">
                                                                    ...
                                                                    <div class="ms-auto">
                                                                        <button
                                                                            class="btn btn-primary btn-sm futureaddmore"
                                                                            type="button">Add</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="futurerecord_list">
                                                                        <div class="row recordrow">
                                                                            <div class="col-md-3 form-input">
                                                                                ...
                                                                                <div class="input-group ">
                                                                                    <input type="text"
                                                                                        ...
                                                                                        data-error="" value=" {{ $futurerecord->date }}"
                                                                                        name="waste[{{ $i }}][future][{{ $j }}][date]"
                                                                                        readonly
                                                                                        id="waste_{{ $i }}_future_date_{{ $j }}"
                                                                                        required="">
                                                                                    <div
                                                                                        class="input-group-addon input-group-text">
                                                                                        <span
                                                                            ...
                                                                            <div class="col-md-3 form-input">
                                                                                <label>Quantity</label>
                                                                                <input type="text"
                                                                                    name="waste[{{ $i }}][future][{{ $j }}][qty]"
                                                                                    value="{{ $futurerecord->qty }}"
                                                                                    data-error="" data-type="future"
                                                                                    class="form-control inputqty validate-input-required"
                                                                                    id="waste_{{ $i }}_future_qty_{{ $j }}">
                                                                            </div>
                                                                            <div class="col-md-3 form-input">
                                                                                <label>Disposal Type</label>
                                                                                <select
                                                                                    name="waste[{{ $i }}][future][{{ $j }}][uom]"
                                                                                    data-type="future"
                                                                                    id="waste_{{ $i }}_future_uom_{{ $j }}"
                                                                                    class="form-control select2 inputuom validate-select-required"
                                                                                    data-error="">
                                                                                    <option value="">Select Disposal
                                                                                        type
                                                                                    ...
                                                                                    @foreach ($disposaltypeList as $disposaltype)
                                                                                        <option
                                                                                        @if($futurerecord->uom == $disposaltype->id) selected @endif
                                                                                            value="{{ $disposaltype->id }}">
                                                                                            {{ $disposaltype->disposaltype_name }}
                                                                                        </option>
                                                                                    @endforeach
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="row recordrow">
                                                                <div class="col-md-3 form-input">
                                                                    <label>Quantity</label>
                                                                    <input type="text"
                                                                        name="waste[{{ $i }}][balance][1][qty]"
                                                                        data-type="balance"
                                                                        value=" {{ $wastelist->total_balance_waste }}"
                                                                        class="form-control inputqty validate-input-required"
                                                                        data-error=""
                                                                        id="waste_{{ $i }}_balance_qty_1">
                                                                </div>
                                                                <div class="col-md-3 form-input">
                                                                    <label>Disposal Type</label>
                                                                    <select
                                                                        name="waste[{{ $i }}][balance][1][uom]"
                                                                        data-type="balance"
                                                                        id="waste_{{ $i }}_balance_uom_1"
                                                                        class="form-control select2 inputuom validate-select-required"
                                                                        data-error="">
                                                                        <option value="">Select Disposal type
                                                                        </option>
                                                                        @foreach ($disposaltypeList as $disposaltype)
                                                                            <option
                                                                            @if ($wastelist->total_balance_waste_type == $disposaltype->id )
                                                                                selected
                                                                            @endif
                                                                            value="{{ $disposaltype->id }}">
                                                                                {{ $disposaltype->disposaltype_name }}
                                                            ...
                                                            <tr>
                                                                <td>
                                                                    ...
                                                                    <input class="finaltotalinput" type="hidden"
                                                                        ...
                                                                        value="{{ $wastetotal[$disposaltype->id]->previous }}"
                                                                        id="input_previous_total_{{ $disposaltype->id }}">
                                                                </td>
                                                                <td>{{ $disposaltype->disposaltype_name }}</td>
                                                                <td>
                                                                    <div class="finaltotal"
                                                                        id="current_total_{{ $disposaltype->id }}">{{ $wastetotal[$disposaltype->id]->current }}</div>
                                                                    <input class="finaltotalinput" type="hidden"
                                                                        name="total[{{ $disposaltype->id }}][current]"
                                                                        value="{{ $wastetotal[$disposaltype->id]->current }}"
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <input class="finaltotalinput" type="hidden"
                                                                        ...
                                                                        value="{{ $wastetotal[$disposaltype->id]->afterdisposal }}"
                                                                        id="input_afterdisposal_total_{{ $disposaltype->id }}">
                                                                </td>
                                                                <td>{{ $disposaltype->disposaltype_name }}</td>
                                                                <td>
                                                                    <div class="finaltotal"
                                                                        id="future_total_{{ $disposaltype->id }}">{{ $wastetotal[$disposaltype->id]->future }}</div>
                                                                    <input class="finaltotalinput" type="hidden"
                                                                        name="total[{{ $disposaltype->id }}][future]"
                                                                        value="{{ $wastetotal[$disposaltype->id]->future }}"
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <input class="finaltotalinput" type="hidden"
                                                                        ...
                                                                        value="{{ $wastetotal[$disposaltype->id]->balance }}"
                                                                ...
                                                                @if ($k == 1)
                                                                    <td rowspan="{{ count($disposaltypeList) }}"
                                                                        ...
                                                                        <input type="hidden" name="total_weight" value="{{ $wasteDetails->total_weight }}"
                                                                            id="input_overall_weight">
                                                                    </td>
                                                                @endif
                                                                @php
                                                                    $k++;
                                        ...
                                        <div class="row g-3 px-4 pt-4">
                                            ...
                                            <div class="col-md-4 form-input">
                                                ...
                                                <div class="input-group date">
                                                    <input type="text" class="form-control validate-input-required"
                                                        ...
                                                        name="reporter_name" readonly value="{{ getuser($wasteDetails->created_by)->name }}">
                                            ...
                                            <div class="col-md-4 form-input">
                                                ...
                                                <div class="input-group date">
                                                    <input type="text" class="form-control validate-input-required"
                                                        ...
                                                        name="dateandtime" readonly value="{{ displayDateTimeFormat($wasteDetails->created_at) }}">
                                            ...
                                            <div class="col-md-12 form-input">
                                                ...
                                                <textarea name="reporter_remarks" id="reporter_remarks" class="form-control" rows="5" required>{{ $wasteDetails->remarks }}</textarea>
                                            </div>
