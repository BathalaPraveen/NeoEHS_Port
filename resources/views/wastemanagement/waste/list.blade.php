                ...
                <div class="card-body">
                    <div class="d-lg-flex align-items-center gap-3">
                        ...
                        <div class="position-relative">
                            <h5 class="card-title">Waste List</h5>
                        </div>
                        <div class="ms-auto">
                            ...
                            <a href="{{ admin_url('wastemanagement/waste/add') }}" class="btn btn-primary">
                                New
                            </a>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.datatable-list').DataTable({
                ...
                "ordering": false,
                ajax: {
                    url: "{{ admin_url('wastemanagement/waste/list') }}",
                    type: 'POST',
                    headers: {
                        ...
                        buttons: [{
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('wastemanagement/waste/export/pdf') }}" +
                                        '?search=' + searchValue +
                            ...
                            },
                            {
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('wastemanagement/waste/export/excel') }}" +
                                        '?search=' + searchValue +
                                        '&machinerytype=' + machinerytype +
                                        '&location=' + location +
                                        '&status=' + status;
            ...
            $(document).on('click', '.StatusChange', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('wastemanagement/waste/status') }}",
                            type: 'post',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                    .attr('content')
            ...
            $(document).on('click', '.recordDelete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('wastemanagement/waste/delete') }}",
                            type: 'post',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                    .attr('content')
