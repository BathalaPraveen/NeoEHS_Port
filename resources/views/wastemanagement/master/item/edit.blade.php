<div>
    <form action="{{ admin_url('wastemanagement/master/item/edit/submit') }}" id="item_edit" method="POST" novalidate>
        @csrf
        <input type="hidden" name="" idvalue="{{encryptId($item->id)}}">
        <div class="modal-header">
            <h5 class="modal-title">Waste Item Edit</h5>
