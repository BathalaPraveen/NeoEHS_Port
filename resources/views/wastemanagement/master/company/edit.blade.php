<div>
    <form action="{{ admin_url('wastemanagement/master/company/edit/submit') }}" id="category_add" method="POST" novalidate>
        @csrf
        <input type="hidden" name="id" value="{{encryptId($company->id)}}">
        <div class="modal-header">
            <h5 class="modal-title">Waste Company Edit</h5>
        ...
        <div class="modal-body m-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9 form-input">
                    <textarea type="text" name="company_address" class="form-control" id="company_address" placeholder="" 
                    value={{$company->company_address}}>{{$company->company_address}}</textarea>
                </div>
            </div>
            <div class="row mb-3">
