                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Waste Card Add</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Waste Card Add</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            <form class="" id="useeuact_add" novalidate method="POST" enctype="multipart/form-data"
                                action="{{ admin_url('wastemanagement/' . $companyname . '/wastecard/add/submit') }}">
                                            ...
                                            <div class="col-md-4 form-input">
                                                ...
                                                <select name="company" id="company" class="form-control select2">
                                                    ...
                                                    @foreach ($wastecompanyList as $wastecompany)
                                                        <option selected value="{{ encryptId($wastecompany->id) }}"
                                                ...
                                                <div class="personalinjury">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-2 form-input">
                                                            ...
                                                            <select name="per_inju[1][risk]" id="per_inju_1_risk"
                                                        ...
                                                        <div class="col-md-3  form-input">
                                                            <label for="form_in_room_temp"
                                                                class="form-label require">Symptoms of Intoxication</label>
                                                            <textarea name="per_inju[1][symptoms]" id="per_inju_1_symptoms" class="form-control validate-textarea-required"
                                                                rows="3"></textarea>
                                                        </div>
                                                        <div class="col-md-3  form-input">
                                                            <label for="form_in_room_temp"
                                                                class="form-label require">First Aid</label>
                                                            <textarea name="per_inju[1][firstaid]" id="per_inju_1_firstaid" class="form-control validate-textarea-required"
                                                                rows="3"></textarea>
                                                        </div>
                                                        <div class="col-md-3  form-input">
                                                            <label for="form_in_room_temp"
                                                                ...
                                                                Physician</label>
                                                            <textarea name="per_inju[1][guidephy]" id="per_inju_1_guidephy" class="form-control validate-textarea-required"
                                                                rows="3"></textarea>
                                                        </div>
                                            ...
                                            <div id="materialdamageslist">
                                                <div class="materialdamages">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-3  form-input">
                                                            <label for="form_in_room_temp"
                                                                class="form-label require">Spill on the Floor, Soil, Road,
                                                                Water</label>
                                                            <textarea name="metedamage[1][spill]" id="metedamage_1_spill" class="form-control validate-textarea-required"
                                                                rows="3"></textarea>
                                                        </div>
                                                        <div class="col-md-3  form-input">
                                                            <label for="form_in_room_temp"
                                                                class="form-label require">Fire</label>
                                                            <textarea name="metedamage[1][fire]" id="metedamage_1_fire" class="form-control validate-textarea-required"
                                                                rows="3"></textarea>
                                                        </div>
                                                        <div class="col-md-3  form-input">
                                                            <label for="form_in_room_temp"
                                                                class="form-label require">Explosion</label>
                                                            <textarea name="metedamage[1][explosion]" id="metedamage_1_explosion" class="form-control validate-textarea-required"
                                                                rows="3"></textarea>
                                                        </div>
                                                        <div class="col-md-1  form-input">
                                                            <div>
