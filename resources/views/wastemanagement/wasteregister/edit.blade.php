...
@section('title', 'Waste Registered Edit')
                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Waste Registered Edit</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Waste Registered Edit</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            <form class="" id="useeuact_add" novalidate method="POST" enctype="multipart/form-data"
                                action="{{ admin_url('wastemanagement/' . $companyname . '/wasteregister/edit/submit') }}">

                                <div class=" border rounded ">
                                    <div class="">
                                        @csrf
                                        <input type="hidden" name="companyname" value="{{ $companyname }}">
                                        <input type="hidden" name="id" value="{{  encryptId($wasteregister->id) }}">

                                        <div class="card-header card-header-inner ">
                                            <h6 class="text-white">Edit Waste Registration</h6>
                                        </div>
                                        ...
                                        <div class="row g-3 px-4 pt-4 mb-3">
                                                ...
                                                <select name="waste_code" id="waste_code" class="form-control select2">
                                                    ...
                                                    @foreach ($wastetypeList as $wastetype)
                                                        <option value="{{ encryptId($wastetype->id) }}"
                                                            @selected($wasteregister->waste_code == $wastetype->id)
                                                ...
                                                <select name="waste_form" id="waste_form" class="form-control select2">
                                                    ...
                                                    @foreach ($wasteformList as $wasteform)
                                                        <option value="{{ encryptId($wasteform->id) }}"
                                                            @selected($wasteregister->waste_form == $wasteform->id)>
                                                            {{ $wasteform->item_name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-4 form-input">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="notification_date" id="notification_date"
                                                        value="{{ displaydateformat($wasteregister->notification_date) }}"
                                            ...
                                            <div class="col-md-4 form-input">
                                                ...
                                                <input type="text" name="notification_no" id="notification_no"
                                                    value="{{ $wasteregister->notification_no }}" class="form-control"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
