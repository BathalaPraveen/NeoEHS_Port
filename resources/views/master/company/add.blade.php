                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Company Add</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Company Add</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            <form id="specific_location_add" novalidate method="POST"
                                action="{{ admin_url('company/add/submit') }}">
                                ...
                                <div class="p-4 border rounded">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4 form-input">
                                            <label for="company_id" class="form-label require">Company ID</label>
                                            <input type="text" name="company_id" class="form-control" id="company_id"
                                                value="{{ getsequence('company') }}" readonly required>
                                        </div>

                                        <div class="col-md-4 form-input">
                                            <label for="company_name" class="form-label require">Company Name</label>
