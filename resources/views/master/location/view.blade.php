                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                <div class="position-relative">
                                    <h5 class="card-title">Location View</h5>
                                </div>
                                <div class="ms-auto">
                                    <a href="{{ admin_url('location/list') }}" data-bs-toggle="tooltip" title="Back" class="btn btn-primary">
                                        Back
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="p-4 border rounded">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-6 form-input">
                                        <label for="location_id" class="form-label font-weight-bold">Location ID</label>
                                    ...
                                    <div class="col-md-12 form-input">
                                        <label for="location_address" class="form-label font-weight-bold">Location
                                            Address</label>
                                        <div>{{ $location->location_address }}</div>
                                    </div>
