...
@section('title', 'Contractor Password Reset')
                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Contractor Password Reset</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Contractor Password Reset</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            <form class="row g-3" id="password_update" novalidate method="POST"
                                action="{{ admin_url('contractor/passwordchange/submit') }}">
                                <div class="p-4 border rounded">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-4 form-input">
                                            <label for="cont_id" class="form-label require">Contractor ID</label>
                                            <input type="text" name="cont_id" class="form-control" id="cont_id"
                                                value="{{ $contractor->cont_id }}" required readonly>
                                        </div>
                                        <div class="col-md-4 form-input">
                                            <label for="cont_name" class="form-label require">Contractor Name</label>
                                            <input type="text" name="cont_name" class="form-control" id="cont_name"
                                                value="{{ $contractor->cont_name }}" required readonly>
                                        </div>
                                    </div>
                                    <div class="row g-3">
                                        @csrf
