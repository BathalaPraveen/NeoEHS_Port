                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Contractor Edit</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Contractor Edit</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            <form class="" id="contractor_edit" novalidate method="POST"
                                action="{{ admin_url('contractor/edit/submit') }}">
                                <div class="p-4 border rounded">
                                    <div class="row">
                                        @csrf
                                        <input type="hidden" name="id" value="{{ encryptId($contractor->id) }}">
                                        ...
                                        <div class="col-md-4 form-input">
                                            ...
                                            <input type="text" name="con_id" class="form-control" id="con_id"
                                                value="{{ $contractor->cont_id }}" required readonly>
                                        </div>
                                        <div class="col-md-4 form-input">
                                            ...
                                            <input type="text" name="con_name" class="form-control" id="con_name"
                                                value="{{ $contractor->cont_name }}" required>
                                        </div>
                                        {{-- <div class="col-md-4 form-input">
                                            <label for="con_gender" class="form-label ">Gender</label>
                                            <select name="con_gender" id="con_gender" class="form-control select2" >
                                                <option value="">Select Gender</option>
                                                <option @if ($contractor->cont_gender == 1) selected @endif
                                                    value="{{ encryptId(1) }}">Male</option>
                                                <option @if ($contractor->cont_gender == 2) selected @endif
                                        ...
                                        {{-- <div class="col-md-4 form-input">
                                            ...
                                            <select name="con_nationality" id="con_nationality" class="form-control select2"
                                                ...
                                                @foreach ($nationalitylist as $nationality)
                                                    <option @if ($contractor->cont_nationality == $nationality->id) selected @endif
                                                        value="{{ encryptId($nationality->id) }}">
                                                        {{ $nationality->nationality }}</option>
                                                @endforeach
                                                <option @if ($contractor->cont_nationality == 0) selected @endif value="0">
                                                    Others
                                                </option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4 form-input " id="con_nationality_other_div"
                                            ...
                                            <input type="text" name="con_nationality_other" class="form-control"
                                                id="con_nationality_other"
                                                value="{{ $contractor->cont_nationality_other }}" required>
                                        </div> --}}
                                        ...
                                        <div class="col-md-4 form-input">
                                            ...
                                            <select name="id_type" id="id_type" class="form-control select2" required>
                                                ...
                                                <option @if ($contractor->cont_id_type == 1) selected @endif
                                                    value="{{ encryptId(1) }}">IC Number</option>
                                                <option @if ($contractor->cont_id_type == 2) selected @endif
                                                    value="{{ encryptId(2) }}">Passport Number</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-4 form-input">
                                            ...
                                            <input type="text" name="con_mc_or_passport_no" class="form-control"
                                                id="con_mc_or_passport_no" value="{{ $contractor->cont_id_number }}"
                                                required>
                                        </div>
                                        ...
                                        <div class="col-md-4 form-input">
                                            ...
                                            <input type="text" name="con_designation_id" class="form-control"
                                                id="con_designation_id" value="{{ $contractor->cont_designation }}"
                                                required>
                                        </div>
                                        ...
                                        <div class="col-md-4 form-input">
                                            ...
                                            <select name="con_company_id" id="con_company_id" class="form-control select2"
                                                ...
                                                @foreach ($companylist as $company)
                                                    <option @if ($contractor->cont_company_id == $company->id) selected @endif
                                        ...
                                        <div class="col-md-4 form-input " id="con_company_other_div"
                                            @if ($contractor->cont_company_id != 0) style="display: none" @endif>
