                ...
                <div class="card-body">
                    <div class="d-lg-flex align-items-center gap-3">
                        ...
                        <div class="ms-auto">
                            ...
                            <a href="{{ admin_url('user/role/add') }}" data-bs-toggle="tooltip" title="New"
        ...
        $(function() {
                        ...
                        buttons: [{
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('user/role/export/pdf') }}" +
                                        '?search=' +
                                        searchValue;
                                }
                            },
                            {
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('user/role/export/excel') }}" +
                                        '?search=' +
                                        searchValue;
                                }
                            },
            ...
            $(document).on('click', '.StatusChange', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('user/role/status') }}",
                            type: 'post',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                    .attr('content')
            ...
            $(document).on('click', '.recordDelete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('user/role/delete') }}",
                            type: 'post',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                    .attr('content')
