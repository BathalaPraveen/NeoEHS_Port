                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">User Role Add</li>
                        </ol>
                    </nav>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">User Role Add</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            <form class="" id="role_add" novalidate method="POST"
                                action="{{ admin_url('user/role/add/submit') }}">
                                <div class="p-4 border rounded">
                                    <div class="row">
                                        @csrf

                                        <div class="col-md-4 form-input">
                                            <label for="role_id" class="form-label require">User Role ID</label>
                                            <input type="text" name="role_id" class="form-control" id="role_id"
                                                value="{{ getsequence('role') }}" readonly required>
                                        </div>

                                        <div class="col-md-4 form-input">
                                            <label for="role_name" class="form-label require">User Role Name</label>
