                ...
                <div class="card-body">
                    <div class="d-lg-flex align-items-center gap-3">
                        ...
                        <div class="ms-auto">
                            ...
                            <a href="{{ admin_url('division/add') }}" data-bs-toggle="tooltip" title="New"
    ...
    <script type="text/javascript">
        $(function() {
                        ...
                        buttons: [{
                            ...
                            },
                            {
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('division/export/excel') }}" +
                                        '?search=' +
                                        searchValue;
                                }
                            },
            ...
            $(document).on('click', '.StatusChange', function() {
                ...
                if (types == 1) {
                    var title = 'Do you want to In-Activate the Division';
                    var text = 'In-Activate';
                    var btncolor = '#dc3545'

                } else {
                    var title = 'Do you want to Activate the Division';
                    var text = 'Activate';
                    var btncolor = '#7ddc35'
                }
            ...
            $(document).on('click', '.recordDelete', function() {
                ...
                var title = 'Do you want to delete the Division';
                var text = 'Delete';
                var btncolor = '#dc3545'
