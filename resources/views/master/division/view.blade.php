                        ...
                        <div class="card-body">
                            ...
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Division View</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            <div class="p-4 border rounded">
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4 form-input">
                                        <label for="division_id" class="form-label font-weight-bold">Division ID</label>
                                        <div>{{ $division->division_id }}</div>
                                    </div>
                                    ...
                                    <div class="col-md-4 form-input">
                                        <label for="division_name" class="form-label font-weight-bold">Division Name</label>
                                        <div>{{ $division->division_name }}</div>
                                    </div>
                                    <div class="col-md-8 form-input">
                                        <label for="division_short_name" class="form-label font-weight-bold">Division Short Name</label>
                                        <div>{{ $division->division_shortname }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
