...
@section('title', 'Company Activity Type Add')
                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Company Activity Type Add</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Company Activity Type Add</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            <hr />
                            <form class="" id="activity_type_add" novalidate method="POST"
                                action="{{ admin_url('activity_type/add/submit') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-input mb-3">
                                            ...
                                            <input type="text" name="activity_id" class="form-control" id="activity_id"
                                                value="{{ getsequence('activity_name') }}" readonly required>
                                        </div>
                                        ...
                                        <div class="col-md-4 form-input mb-3">
                                            ...
                                            <input type="text" name="activity_name" class="form-control"
                                                id="activity_name" value="" required>
                                        </div>
                                    </div>
                                </div>
