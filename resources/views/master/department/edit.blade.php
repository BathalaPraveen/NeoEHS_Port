                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Department Edit</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            <hr />
                            <form class="" id="department_edit" novalidate method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 form-input">
                                            ...
                                            <select name="division_id" id="division_id" class="form-control select2"
                                                required>
                                                <option value="">Select Department</option>
                                                @foreach ($divisionDetails as $divi)
                                                    <option value="{{ encryptId($divi->id) }}"
                                                        @if ($divi->id == $division->company_id) selected @endif>
                                                        {{ $divi->division_name }}</option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="col-md-4 form-input">
                                            ...
                                            <input type="text" name="department_id" class="form-control"
                                                id="department_id" value="{{ $division->department_id }}" readonly required>
                                        </div>
                                        <div class="col-md-4 form-input">
                                            <label for="department_name" class="form-label require">Department
                                                Name</label>
                                            <input type="text" name="department_name" class="form-control"
                                                value="{{ $division->department_name }}" id="department_name" required>
                                        </div>
                                        ...
                                        <div class="col-md-4 form-input">
                                            ...
                                            <input type="text" name="department_shortname" class="form-control"
                                                value="{{ $division->department_shortname }}" id="department_shortname">
                                            ...
                                            <select name="dept_admin[]" id="dept_admin" class="form-control select2"
                                                ...
                                                @foreach ($employeeDetails as $employee)
                                                    <option value="{{ encryptId($employee->id) }}"
                                                         {{ in_array($employee->id, explode(',', $division->dept_admin)) ? 'selected' : '' }}>
