...
@section('title', 'Contractor Company Edit')
                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Contractor Company Edit</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Contractor Company Edit</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            <hr />
                            <form class="" id="contractor_company_edit" novalidate method="POST"
                                action="{{ admin_url('contractor/company/edit/submit') }}" enctype="multipart/form-data">
                                            ...
                                            <select name="state" id="state" class="form-control select2">
                                                ...
                                                @foreach ($malaysiaStates as $state)
                                                    <option value="{{ $state->state_name }}"
                                                        {{ $conCompany->state == $state->state_name ? 'selected' : '' }}>
                                                        {{ $state->state_name }}
                                                    </option>
                                                @endforeach
                                            </select>
...
@push('script')
    <script type="text/javascript">
        function hideUploads() {
            const downloadDiv = document.getElementById('ssm_download_div');
            downloadDiv.style.display = 'none';
        }
        $(function() {

            $('#contractor_company_edit').validate({
                rules: {
                    con_comp_id: {
                        required: true,
                    },
