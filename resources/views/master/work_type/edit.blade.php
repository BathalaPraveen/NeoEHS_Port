                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Work Type Edit</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="col">
                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body">
                            ...
                            <hr />
                            <form class="" id="work_type_edit" novalidate method="POST"
                                action="{{ admin_url('work_type/edit/submit') }}">
                                <div class="p-4 border  rounded">
                                    <div class="row">
                                        @csrf
                                        <input type="hidden" value="{{ encryptId($work_type->id) }}" name="id">
                                        <div class="col-md-4 form-input mb-3">
                                            ...
                                            <input type="text" name="work_type_id" class="form-control" id="work_type_id"
                                                value="{{ $work_type->work_type_id }}" readonly required>
                                        </div>
                                        <div class="col-md-4 form-input mb-3">
                                            ...
                                            <input type="text" name="work_type_name" class="form-control"
                                                id="work_type_name" value="{{ $work_type->work_type_name }}" required>
                                        </div>
                                            ...
                                            <select name="supervising_authority[]" id="supervising_authority"
                                                ...
                                                @foreach ($employeeDetails as $employee)
                                                    <option value="{{ encryptId($employee->id) }}"
                                                        {{ in_array($employee->id, explode(',', $work_type->supervising_authority)) ? 'selected' : '' }}>
                                                        {{ $employee->name }}
                                                    </option>
                                                @endforeach
                                        ...
                                        <div class="col-md-12 form-input">
                                            <label for="work_type_description" class="form-label ">Work Type
                                                Description</label>
                                            <textarea class="form-control" name="work_type_description" id="work_type_description" rows="5">{{ $work_type->work_type_description }}</textarea>
                                        </div>
                                    </div>
                                </div>
