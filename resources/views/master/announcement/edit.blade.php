                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Announcement Edit</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            <form id="specific_location_add" novalidate method="POST"
                                action="{{ admin_url('settings/announcement/edit/submit') }}">

                                <div class="p-4 border rounded">
                                    <div class="row g-3">

                                        @csrf
                                        <input type="hidden" name="id" value="{{ encryptId($announcement->id) }}">
                                        <div class="col-md-4 form-input">
                                            ...
                                            <input type="text" name="announcement_id" class="form-control"
                                                id="announcement_id"  readonly value="{{ $announcement->announcement_id }}"
                                                required>
                                        </div>
                                        ...
                                        <div class="col-md-12 form-input">
                                            ...
                                            <input type="text" name="announcement_title" class="form-control"
                                                id="announcement_title" value="{{ $announcement->announcement_title }}" required>
                                        </div>

                                        <div class="col-md-12 form-input">
                                            <label for="announcement_content" class="form-label require">Announcement
                                                Content</label>
                                            <textarea name="announcement_content" class="form-control"id="announcement_content" rows="5">{{ $announcement->announcement_content }}</textarea>
