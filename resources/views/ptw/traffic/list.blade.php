...
@section('title', 'Worksite Traffic PTW List')
                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Worksite Traffic Management Certificate</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-lg-flex align-items-center gap-3">
                        ...
                        <div class="position-relative">
                            <h5 class="card-title">Worksite Traffic PTW List</h5>
                        </div>
                        <div class="ms-auto">
                            ...
                            {{-- <a href="{{ admin_url('ptw/worktraffic/add') }}" class="btn btn-primary">
                                New
                            </a> --}}
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.datatable-list').DataTable({
                        ...
                        buttons: [{
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('ptw/worktraffic/export/pdf') }}" +
                                        '?search=' + searchValue +
                                        '&location=' + location +
                                        '&status=' + status;
                                }
                            },
                            {
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('ptw/worktraffic/export/excel') }}" +
                                        '?search=' + searchValue +
                                        '&location=' + location +
                                        '&status=' + status;
                                }
                ...
                "ordering": false,
                ajax: {
                    url: "{{ admin_url('ptw/worktraffic/list') }}",
                    type: 'POST',
                    headers: {
