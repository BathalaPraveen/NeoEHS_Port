                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body">
                            ...
                            <form id="general_ptw_add" novalidate method="POST" enctype="multipart/form-data"
                                action="{{ admin_url('ptw/worktraffic/add/submit') }}">
                                @csrf
                                ...
                                <div class=" border rounded">
                                    ...
                                    <div class="row g-3 p-4">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-4 form-input">
                                                <textarea name="reasonclosing" id="reasonclosing" class="form-control" required rows="3"></textarea>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-4 form-input">
                                                <textarea name="periodorduratio" id="periodorduratio" required class="form-control" rows="3"></textarea>
                                            </div> --}}
                                            <label class="col-sm-2 col-form-label require">
                                                Work Start Date
                                            </label>
                                            <div class="col-md-4 form-input">
                                                <div class="input-group  ">
                                                    <input type="text" class="form-control workstartdate " required
                                            ...
                                            <div class="col-md-4 form-input">
                                                <div class="input-group  ">
                                                    <input type="text" class="form-control  " required id="workenddate"
                                    ...
                                    <div class="row g-3 p-4">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-3 form-input">
                                                <div class="m-2">
                                                    <input type="file" name="uploadplan" class="form-control" required
                                                        id="uploadplan">
                                                </div>
                                            </div>
                                    ...
                                    <div class="row g-3 p-4">
                                        ...
                                        <div class="col-md-12">
                                            <div>Others</div>
                                            <textarea name="wtmothers" id="wtmothers" class="form-control" rows="3"></textarea>
                                        </div>
                                        <hr>
                                    </div>
                                    ...
                                    <div class="row g-3 p-4">
                                        ...
                                        <p>worksite traffic management proposed under Permit to Work number
                                            <input type="text" name="workpermitnymber" id="workpermitnymber">
                                            dated <input type="text" name="workpermitdate" readonly
                                        ...
                                        <textarea name="otherserice" id="otherserice" class="form-control" rows="4"></textarea>
