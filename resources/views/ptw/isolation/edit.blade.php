...
@section('title', 'Isolation Certificate Edit')
                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Isolation Certificate Edit</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Isolation Certificate Edit</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            <form id="isolation_ptw_add" novalidate method="POST" enctype="multipart/form-data"
                                action="{{ admin_url('ptw/isolation/edit/submit') }}">
                                @csrf

                                <input type="hidden" name="id" value="{{ encryptId($isolation->id) }}">
                                <div class=" border rounded">
                                        ...
                                        <table class="table table-borderless">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="width:35%;" class="form-input">
                                                        <input type="text" name="durationofisolation" required
                                                            value="{{ $isolation->durationofisolation }}"
                                                    ...
                                                    <td>
                                                        <div class="form-input">
                                                            <textarea name="whatdoisolate" id="whatdoisolate" required class="form-control" rows="3">{{ $isolation->whatdoisolate }}</textarea>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-input">
                                                            <textarea name="sourceofenergy" id="sourceofenergy" class="form-control" required rows="3">{{ $isolation->sourceofenergy }}</textarea>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <label class="  require">
                                                    ...
                                                    <td class="form-input">
                                                        <div class="input-group  ">
                                                            <input type="text" class="form-control workstartdate "
                                                                value=" {{ $isolation->workstartdate }}" required
                                                    ...
                                                    <td class="form-input">
                                                        <div class="input-group  ">
                                                            <input type="text" class="form-control  " required
                                                                value=" {{ $isolation->workenddate }}" id="workenddate"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="4">
                                                        <div class="form-input">
                                                            <textarea name="workdescription" id="workdescription" required class="form-control" rows="3">{{ $isolation->workdescription }}</textarea>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <tbody>
                                                    @foreach ($isolationArray as $details)
                                                        <tr class="isolationmain">
                                                            <td class="form-input">
                                                                <input type="text"
                                                                    name="isolation[{{ $i }}][point]"
                                                                    value="{{ $details->point }}"
                                                                    class="form-control validate-input-required"
                                                                    id="isolation_point_{{ $i }}">
                                                            </td>
                                                            <td class="form-input">
                                                                <input type="text"
                                                                    name="isolation[{{ $i }}][lock]"
                                                                    value="{{ $details->lock }}"
                                                                    class="form-control validate-input-required"
                                                                    id="isolation_lock_{{ $i }}">
                                                            </td>
                                                            <td class="form-input">
                                                                <div class="input-group clockpicker"
                                                                    data-placement="bottom" data-align="bottom"
                                                                    data-autoclose="true">
                                                                    <input type="text"
                                                                        id="isolation_time_{{ $i }}" required
                                                                        value="{{ $details->time }}"
                                                                        class="form-control validate-input-required"
                                                                        readonly placeholder=""
                                                                        name="isolation[{{ $i }}][time]" />
                                            ...
                                            <div class="col-md-4">
                                                <div class="m-2 form-input">
                                                    <input type="text" name="loockoutapplied" id="loockoutapplied"
                                                        value="{{ $isolation->loockoutapplied }}" required
                                                        class="form-control">
                                                </div>
                                            </div>
                                            <label class="col-sm-2 col-form-label require">
                                            ...
                                            <div class="col-md-4">
                                                <div class="m-2 form-input">
                                                    <input type="text" name="icno" id="icno" required
                                                        value=" {{ $isolation->icno }}" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-3 p-4">
                                                            ...
                                                            @foreach ($days as $day)
                                                                <td>
                                                                    <input type="checkbox" class="form-check-input"
                                                                        @if (isset($isolatiodailycheckArray->$intervel->$day)) checked @endif
                                                                        name="isolatiodailycheck[{{ $intervel }}][{{ $day }}]">
                                                                </td>
                                                            @endforeach
                                                            <td><input type="text"
                                                                    value="{{ $isolatiodailycheckArray->$intervel->status }}"
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-10">
                                                <div class="m-2">
                                                    <textarea name="isolationremarks" id="isolationremarks" class="form-control" rows="5">{{ $isolation->isolationremarks }}</textarea>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row g-3 p-4">
                                        ...
                                        <div class="row mb-3 mt-3">
                                            ...
                                            <div class="col-sm-4 form-input">
                                                <input type="text" class="form-control" id="applieduser"
                                                    value=" {{ getusername($isolation->created_by) }}" readonly>
                                            </div>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-10 form-input">
                                                <textarea name="applicant_remarks" required id="applicant_remarks" class="form-control" rows="3">{{ $isolation->applicant_remarks }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
