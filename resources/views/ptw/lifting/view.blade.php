...
@section('title', 'Lifting PTW View')
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ admin_url('ptw/lifting/list') }}">Lifting PTW</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Lifting PTW View</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Lifting PTW View</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            @include('ptw.pages.liftingplancertificate')

                            @if ($lifting->ptw_status == SUBPERMIT_STATUS_PENDING )
                                @if (isset($approvereject))
                                <form action="{{ admin_url('ptw/lifting/approvereject/submit') }}" method="POST">
