                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body">
                            ...
                            <form id="general_ptw_add" novalidate method="POST" enctype="multipart/form-data"
                                action="{{ admin_url('ptw/lifting/edit/submit') }}">
                                @csrf
                                <input type="hidden" name="id" value="{{ encryptId($lifting->id) }}">
                                    ...
                                    <div class="row g-3 p-4">
                                            ...
                                            <div class="col-md-3 form-input">
                                                <div class="input-group  ">
                                                    <input type="text" class="form-control workstartdate "
                                                        value="{{ displayDateformat($lifting->workstartdate) }}" required
                                                        id="workstartdate" name="workstartdate" readonly>
                                            ...
                                            <div class="col-md-3 form-input">
                                                <div class="input-group  ">
                                                    <input type="text" class="form-control  " required
                                                        value="{{ displayDateformat($lifting->workenddate) }}"
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-10" class="form-input">
                                                <textarea name="workdescription" id="workdescription" class="form-control" required rows="3">{{ $lifting->workdescription }}</textarea>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row g-3 p-4">
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-10 form-input">
                                                <div class="m-2">
                                                    <textarea name="loaddescription" required id="loaddescription" class="form-control" rows="3">{{ $lifting->loaddescription }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-10 form-input">
                                                <div class="m-2">
                                                    <input type="text" name="overalldimension" id="overalldimension"
                                                        value="{{ $lifting->overalldimension }}" required
                                                        class="form-control">
                                            ...
                                            <div class="col-md-4 form-input">
                                                <div class="m-2">
                                                    <input type="text" name="loadweight" id="loadweight" required
                                                        value="{{ $lifting->loadweight }}" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-3 form-input">
                                                <div class="m-2">
                                                    ...
                                                    <input class="form-check-input" type="radio" value="knownweight"
                                                        @if ($lifting->weight_type == 'knownweight') checked @endif name="weight_type"
                                                        id="weight_type_known" required>
                                            ...
                                            <div class="col-md-3 form-input">
                                                <div class="m-2">
                                                    ...
                                                    <input class="form-check-input" type="radio"
                                                        @if ($lifting->weight_type == 'estimatedweight') checked @endif
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-3 form-input">
                                                <div class="m-2">
                                                    <input class="form-check-input" type="radio" value="obvious"
                                                        @if ($lifting->centerofgravity == 'obvious') checked @endif
                                            ...
                                            <div class="col-md-3 form-input">
                                                <div class="m-2">
                                                    ...
                                                    <input class="form-check-input" type="radio" value="estimated"
                                                        @if ($lifting->centerofgravity == 'estimated') checked @endif
                                            ...
                                            <div class="col-md-3 form-inpt">
                                                <div class="m-2">
                                                    <input class="form-check-input" type="radio"
                                                        @if ($lifting->centerofgravity == 'determinedbydrawing') checked @endif
                                                    ...
                                                    @foreach ($riggingdetails as $rigging)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="form-input">
                                                                <input type="text"
                                                                    class="form-control validate-input-required"
                                                                    value="{{ $riggingDetails->$riggingId->size }}"
                                                            ...
                                                            <td class="form-input">
                                                                <input type="text"
                                                                    class="form-control validate-input-required"
                                                                    value="{{ $riggingDetails->$riggingId->swl }}"
                                                            ...
                                                            <td class="form-input">
                                                                <input type="text"
                                                                    class="form-control validate-input-required"
                                                                    value="{{ $riggingDetails->$riggingId->quantity }}"
                                                            ...
                                                            <td class="form-input">
                                                                <input type="text"
                                                                    class="form-control validate-input-required"
                                                                    value="{{ $riggingDetails->$riggingId->weight }}"
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-4 form-input">
                                                <input type="text" name="ligtgearsweight" id="ligtgearsweight"
                                                    value="{{ $lifting->ligtgearsweight }}" required
                                                    class="form-control">
                                            </div>
                                            ...
                                            <div class="col-md-4 form-input">
                                                <input type="text" name="totalweight" id="totalweight" required
                                                    value="{{ $lifting->totalweight }}" class="form-control">
                                            </div>
                                        </div>
                                        <hr>
                                    </div>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-4 form-input">
                                                <input type="text" name="meanofcommunication" id="meanofcommunication"
                                                    value="{{ $lifting->meanofcommunication }}" required
                                                    class="form-control">
                                            </div>
                                            ...
                                            <div class="col-md-2 form-input">
                                                <input class="form-check-input" type="radio" value="yes"
                                                    @if ($lifting->loadinpoint == 'yes') checked @endif name="loadinpoint"
                                                    id="loadinpoint_yes" required>
                                                <label class="form-check-label" for="loadinpoint_yes">YES</label>

                                                <input class="form-check-input" type="radio" value="no"
                                                    @if ($lifting->loadinpoint == 'no') checked @endif name="loadinpoint"
                                                    id="loadinpoint_no" required>
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="width: 15% " class="form-input">
                                                        <input class="form-check-input validate-radio-required"
                                                            @if ($env_cond->pec_gc == 'yes') checked @endif type="radio"
                                                            value="yes" name="env_cond[pec_gc]" id="pec_gc_yes">
                                                        <label class="form-check-label" for="pec_gc_yes">YES</label>

                                                        <input class="form-check-input validate-radio-required"
                                                            @if ($env_cond->pec_gc == 'no') checked @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <input class="form-check-input" type="checkbox" value="yes"
                                                            @if (isset($env_cond->pec_env_gc)) checked @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2">
                                                        <input class="form-check-input" type="checkbox" value="yes"
                                                        @if(isset($env_cond->pec_env_wet)) checked @endif
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <input class="form-check-input" type="checkbox" value="yes"
                                                            @if (isset($env_cond->pec_env_scn)) checked @endif
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        ...
                                                        <input class="form-check-input" type="checkbox" value="yes"
                                                            @if (isset($env_cond->pec_others)) checked @endif
                                                            name="env_cond[pec_others]" id="pec_others">
                                                        <label class="form-check-label" for="pec_others"> Other
                                                            circumstances :</label>
                                                        </div>
                                                        <div class="form-check form-check-inline">
                                                            <input type="text" name="env_cond[other_circum]"  id="other_circum" class="form-control" style="width: auto;"  value="{{ isset($env_cond->other_circum) ? $env_cond->other_circum : '' }}">
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        ...
                                        <table class="table table-bordered">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <td style="width:30%">Document Upload</td>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="form-input">
                                                        <input type="text" name="liftingsupervisor" required
                                                            value="{{ $lifting->liftingsupervisor }}"
                                                            id="liftingsupervisor" class="form-control">
                                                    </td>
                                                    <td class="form-input">
                                                        <input type="file" name="liftingsupervisor_document"
                                                            id="liftingsupervisor_document" class="form-control">
                                                        @if (isset($liftingdocument[1]))
                                                            <a href="{{ url($liftingdocument[1]['file_path']) }}"
                                                                target="_blank">{{ $liftingdocument[1]['file_orgname'] }}</a>
                                                        @endif
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td class="form-input">
                                                        <input type="text" name="liftingcraneoperator" required
                                                            value="{{ $lifting->liftingcraneoperator }}"
                                                            id="liftingcraneoperator" class="form-control">

                                                    </td>
                                                    <td class="form-input">
                                                        <input type="file" name="liftingcraneoperator_document"
                                                            id="liftingsupervisor_document" class="form-control">
                                                        @if (isset($liftingdocument[2]))
                                                            <a href="{{ url($liftingdocument[2]['file_path']) }}"
                                                                target="_blank">{{ $liftingdocument[2]['file_orgname'] }}</a>
                                                        @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="form-input">
                                                        <input type="text" name="liftingsignalman" required
                                                            value="{{ $lifting->liftingsignalman }}"
                                                            id="liftingsignalman" class="form-control">

                                                    </td>
                                                    <td class="form-input">
                                                        <input type="file" name="liftingsignalman_document"
                                                            id="liftingsupervisor_document" class="form-control">
                                                        @if (isset($liftingdocument[3]))
                                                            <a href="{{ url($liftingdocument[3]['file_path']) }}"
                                                                target="_blank">{{ $liftingdocument[3]['file_orgname'] }}</a>
                                                        @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="form-input">
                                                        <input type="text" name="liftingrigger" id="liftingrigger"
                                                            value="{{ $lifting->liftingrigger }}" required
                                                            class="form-control">
                                                    </td>
                                                    <td class="form-input">
                                                        <input type="file" name="liftingrigger_document"
                                                            id="liftingsupervisor_document" class="form-control">
                                                        @if (isset($liftingdocument[4]))
                                                            <a href="{{ url($liftingdocument[4]['file_path']) }}"
                                                                target="_blank">{{ $liftingdocument[4]['file_orgname'] }}</a>
                                                        @endif
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Others</td>
                                                    <td>
                                                        <textarea name="liftingothers" id="liftingothers" rows="3" class="form-control">{{ $lifting->liftingothers }}</textarea>
                                                    </td>
                                                    <td>
                                                        <input type="file" name="liftingothers_document"
                                                            id="liftingsupervisor_document" class="form-control">
                                                        @if (isset($liftingdocument[5]))
                                                            <a href="{{ url($liftingdocument[5]['file_path']) }}"
                                                                target="_blank">{{ $liftingdocument[5]['file_orgname'] }}</a>
                                                        @endif
                                                    </td>
                                                </tr>
                                            </tbody>
                                    ...
                                    <div class="row g-3 p-4">
                                        ...
                                        <div class="row mb-3 mt-3">
                                            ...
                                            <div class="col-sm-4 form-input">
                                                <input type="text" class="form-control" id="applieduser"
                                                    value="{{ getusername($lifting->created_by) }}" readonly>
                                            </div>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-10 form-input">
                                                <textarea name="applicant_remarks" required id="applicant_remarks" class="form-control" rows="3">{{ $lifting->applicant_remarks }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
