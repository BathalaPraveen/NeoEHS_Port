                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Diving Certificate</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-lg-flex align-items-center gap-3">
                        ...
                        <div class="position-relative">
                            <h5 class="card-title">Diving PTW List</h5>
                        </div>
                        <div class="ms-auto">
                            ...
                            {{-- <a href="{{ admin_url('ptw/diving/add') }}" class="btn btn-primary">
                                New
                            </a> --}}
                        </div>
                    </div>
                        ...
                        buttons: [{
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('ptw/diving/export/pdf') }}" +
                                        '?search=' + searchValue +
                                        '&location=' + location +
                                        '&status=' + status;
                                }
                            },
                            {
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('ptw/diving/export/excel') }}" +
                                        '?search=' + searchValue +
                                        '&location=' + location +
                                        '&status=' + status;
                                }
