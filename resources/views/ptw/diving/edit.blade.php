...
@section('title', 'Diving Certificate Edit')
                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Diving Certificate Edit</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Diving Certificate Edit</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            <form id="diving_ptw_add" novalidate method="POST" enctype="multipart/form-data"
                                action="{{ admin_url('ptw/diving/edit/submit') }}">
                                @csrf
                                ...
                                <div class=" border rounded">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td colspan="7" class="form-input">
                                                        <textarea name="workdescription" id="workdescription" class="form-control" required rows="3">{{ $diving->workdescription }}</textarea>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Location</td>
                                                    ...
                                                    <td class="form-input">
                                                        <input type="text" name="divingdeep" id="divingdeep" required
                                                            value="{{ $diving->divingdeep }}" class="form-control">
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td class="form-input">
                                                        <div class="input-group  ">
                                                            <input type="text" class="form-control workstartdate "
                                                                value="{{ Displaydateformat($diving->workstartdate) }}"
                                                    ...
                                                    <td class="form-input">
                                                        <div class="input-group  ">
                                                            <input type="text" class="form-control  " required
                                                                value="{{ Displaydateformat($diving->workenddate) }}"
                                                    ...
                                                    <td class="form-input">
                                                        <div class="input-group date ">
                                                            <input type="text" class="form-control datepicker " required
                                                                value="{{ $diving->date }}" id="date" name="date"
                                                                readonly>
                                                            <div class="input-group-addon input-group-text">
                                                                <span class="fa fa-calendar"></span>
                                                            </div>
                                                    ...
                                                    <td class="form-input">
                                                        <div class="input-group clockpicker" data-placement="bottom"
                                                            ...
                                                            <input type="text" id="time" required
                                                                value="{{ $diving->time }}" class="form-control " readonly
                                                    ...
                                                    <td class="form-input">
                                                        <div class="input-group clockpicker" data-placement="bottom"
                                                            ...
                                                            <input type="text" id="estimationtime" required
                                                                value="{{ $diving->estimationtime }}" class="form-control " readonly
                                                                placeholder="" name="estimationtime" />
                                                            <span class="input-group-addon input-group-text">
                                                                <i class="bi bi-clock"></i>
                                                            </span>
                                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="form-input">
                                                        <input type="text" name="applieddatetime" id="applieddatetime"
                                                            ...
                                                            value="{{ Displaydatetimeformat($diving->created_at) }}"
                                                            readonly>
                                                    </td>
                                                </tr>
                                            </tbody>
                                    ...
                                    <div class="row g-3 p-4">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="m-2">
                                                        <input class="form-check-input" type="checkbox"
                                                            @if (in_array($equipment->id, $divingEquipments->equipment)) checked @endif
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-11">
                                                <div class="m-2">
                                                    <textarea name="equipmentothers" id="equipmentothers" rows="3" class="form-control">{{ $divingEquipments->equipmentothers }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="width:5%">
                                                                <input class="form-check-input"
                                                                    @if (in_array($sitepreparation->id, $divingsitepreparationArray)) checked @endif
                                                                    type="checkbox"
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($driversDetails as $driver)
                                                        <tr class="driverdetails">
                                                            ...
                                                            <td class="form-input">
                                                                <input type="text"
                                                                    name="divers[{{ $i }}][idnumber]"
                                                                    value="{{ $driver->idnumber }}"
                                                                    data-error="Please enter IC no /Pass No"
                                                                    id="drivers_idnumber_{{ $i }}"
                                                                    class="form-control validate-input-required">
                                                            </td>
                                                            <td class="form-input">
                                                                <input type="text"
                                                                    name="divers[{{ $i }}][competency]"
                                                                    value="{{ $driver->competency }}"
                                                                    data-error="Please enter Competency"
                                                                    id="drivers_competency_{{ $i }}"
                                                                    class="form-control validate-input-required">
                                                            </td>
                                                            <td class="form-input">
                                                                <input type="text"
                                                                    name="divers[{{ $i }}][healthfitness]"
                                                                    value="{{ $driver->healthfitness }}"
                                                                    data-error="Please enter Health Fitness"
                                                                    id="drivers_healthfitness_{{ $i }}"
                                                                    class="form-control validate-input-required">
                                                            </td>
                                                            <td>
                                    ...
                                    <div class="row g-3 p-4">
                                        ...
                                        <div class="row mb-3 mt-3">
                                            ...
                                            <div class="col-sm-4 form-input">
                                                <input type="text" class="form-control" id="applieduser"
                                                    value="{{ getusername($diving->created_by) }}" readonly>
                                            </div>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-10 form-input">
                                                <textarea name="applicant_remarks" id="applicant_remarks" class="form-control" rows="3">{{ $diving->applicant_remarks }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
