...
@section('title', 'Surface PTW View')
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ admin_url('ptw/surfacepenetration/list') }}">Surface PTW</a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Surface PTW View</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Surface PTW View</h5>
                                </div>
                                <div class="ms-auto">

                                    <a href="{{ admin_url('ptw/surfacepenetration/list') }}" data-bs-toggle="tooltip" title="Back"
                            ...
                            @include('ptw.pages.surfacepenetrationcertificate')


                            @if ($surface->ptw_status == SUBPERMIT_STATUS_PENDING)
                                @if (isset($approvereject))
                                <form action="{{ admin_url('ptw/surfacepenetration/approvereject/submit') }}" method="POST">
