                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body">
                            ...
                            <form id="general_ptw_add" novalidate method="POST" enctype="multipart/form-data"
                                action="{{ admin_url('ptw/surfacepenetration/edit/submit') }}">
                                @csrf
                                <input type="hidden" name="id" value="{{ encryptId($surface->id) }}">
                                <div class=" border rounded">
                                        ...
                                        <table class="table table-borderless">
                                            <tbody>
                                                        ...
                                                        <div class="form-input">
                                                            <div>
                                                                <input class="form-check-input" type="radio"
                                                                    @if ($surface->hazardousarea == 'Hazardous') checked @endif
                                                            ...
                                                            <div>
                                                                <input class="form-check-input" type="radio"
                                                                    @if ($surface->hazardousarea == 'Non-Hazardous') checked @endif
                                                    ...
                                                    <td>
                                                        <div class="form-input">
                                                            <input class="form-check-input" type="checkbox" value="YES"
                                                                @if ($surface->trailexcavation == 'YES') checked @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="form-input">
                                                            ...
                                                            <textarea name="maxexcavationdepth" id="maxexcavationdepth" class="form-control" rows="3">{{ $surface->maxexcavationdepth }}</textarea>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <label class="require">
                                                    ...
                                                    <td>
                                                        <div class="form-input">
                                                            <textarea name="maxexcavationdeep" id="maxexcavationdeep" class="form-control" rows="3">{{ $surface->maxexcavationdeep }}</textarea>
                                                        </div>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="form-input">
                                                            <textarea name="resulttrailfrom" id="resulttrailfrom" class="form-control" rows="3">{{ $surface->resulttrailfrom }}</textarea>
                                                        </div>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td class="form-input">
                                                        <div class="input-group  ">
                                                            <input type="text" class="form-control workstartdate "
                                                                value="{{ $surface->workstartdate }}" required
                                                    ...
                                                    <td class="form-input">
                                                        <div class="input-group  ">
                                                            <input type="text" class="form-control  " required
                                                                value="{{ $surface->workenddate }}" id="workenddate"
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="7">
                                                        <div class="form-input">
                                                            <textarea name="workdescription" id="workdescription" class="form-control" rows="3">{{ $surface->workdescription }}</textarea>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </tbody>
                                    ...
                                    <div class="row g-3 px-2 pt-1">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="m-2">
                                                        <input class="form-check-input" type="checkbox"
                                                            @if (in_array($ppe->id, $ppelistArray)) checked @endif
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-10">
                                                <div class="m-2">
                                                    <textarea name="ppeothers" id="ppeothers" class="form-control" rows="3">{{ $ppelistdetails->ppeothers }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                    ...
                                    <div class="row g-3 px-2 pt-1">
                                        <div class="row mb-2">
                                            ...
                                            @foreach ($equipments as $equipment)
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="m-2">
                                                        <input class="form-check-input" type="checkbox"
                                                            @if (in_array($equipment->id, $equipmentlistArray)) checked @endif
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-10">
                                                <div class="m-2">
                                                    <textarea name="equipmentothers" id="equipmentothers" class="form-control" rows="3">{{ $equipmentlistdetails->equipmentothers }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                    ...
                                    <div class="row g-3 px-2 pt-1">
                                        <div class="row mb-2">
                                            ...
                                            @foreach ($aditionalrequierments as $requierments)
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="m-2">
                                                        <input class="form-check-input" type="checkbox"
                                                            @if (in_array($requierments->id, $addrequiermentslistArray)) checked @endif
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-10">
                                                <div class="m-2">
                                                    <textarea name="requiermentsothers" id="requiermentsothers" class="form-control" rows="3">{{ $addrequiermentslistdetails->requiermentsothers }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                    ...
                                    <div class="row g-3 px-2 pt-1">
                                        <div class="col-md-12">
                                            <p>We hereby have checked the site / studied the
                                                ...
                                                <input type="text" name="accept_worknumber"  value="{{ $surface->accept_worknumber }}"
                                                    class=""> dated <input class="datepicker" readonly value="{{ $surface->accept_work_date }}"
                                                    type="text" name="accept_work_date" class="">
                                                can be carried out:
                                            </p>
                                            ...
                                            <textarea name="accept_work_remarks" rows="3" class="form-control">{{ $surface->accept_work_remarks }}</textarea>
                                        ...
                                        <div class="row mb-3 mt-3">
                                            ...
                                            <div class="col-sm-4 form-input">
                                                <input type="text" class="form-control" id="applieduser"
                                                    value="{{ getusername($surface->created_by) }}" readonly>
                                            </div>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-10 form-input">
                                                <textarea name="applicant_remarks" id="applicant_remarks" class="form-control" rows="3">{{ $surface->applicant_remarks }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@push('script')
    <script type="text/javascript">
        ...
        $(document).on('change', '#workstartdate', function() {
            ...
            var newDate = getEndDate(selectedDate, {{ VALIDITY_SURFACE }}, {{ ADD_DATE }},
