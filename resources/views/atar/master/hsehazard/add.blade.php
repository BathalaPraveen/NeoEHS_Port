<div>
    <form action="{{ admin_url('atar/master/hsehazard/add/submit') }}" id="hse_hazard_add" method="POST" novalidate>
        @csrf
        <div class="modal-header">
            <h5 class="modal-title">Add HSE Issues</h5>
        ...
        <div class="modal-body m-3">
                ...
                <div class="col-sm-9 form-input">
                    <select name="atar_type" id="atar_type" class="select2 form-control" style="width: 100%">
                        ...
                        @foreach ($atarDetails as $atar )
                            <option value="{{ encryptId($atar->id)}}">{{$atar->atar_type}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
                ...
                <div class="col-sm-9 form-input">
                    <select name="zefa_rule" id="zefa_rule" class="select2 form-control" style="width: 100%">
                        ...
                        @foreach ($zefaDetails as $zefa )
                            <option value="{{ encryptId($zefa->id)}}">{{$zefa->zefa_rule}}</option>
                        @endforeach
                    </select>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9 form-input">
                   <input type="text" name="hse_hazard" class="form-control" id="hse_hazard">
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9 form-input">
                    <textarea name="hover_message" id="hover_message" class="form-control" rows="5"></textarea>
                </div>
            </div>
        </div>
