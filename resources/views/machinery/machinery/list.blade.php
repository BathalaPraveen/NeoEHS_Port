                ...
                <div class="card-body">
                    <div class="d-lg-flex align-items-center gap-3">
                        ...
                        <div class="position-relative">
                            <h5 class="card-title">Machinery List</h5>
                        </div>
                        <div class="ms-auto">
                            ...
                            <a href="{{ admin_url('machinery/machinery/add') }}" class="btn btn-primary">
                                New
                            </a>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.datatable-list').DataTable({
                ...
                "ordering": false,
                ajax: {
                    url: "{{ admin_url('machinery/machinery/list') }}",
                    type: 'POST',
                    headers: {
                ...
                columns: [
                    ...
                    {
                        data: 'machinery_type_name',
                        name: 'machinery_type_name'
                    },
                    ...
                    {
                        data: 'machinery_status',
                        name: 'machinery_status'
                    },
                        ...
                        buttons: [{
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('machinery/machinery/export/pdf') }}" +
                                        '?search=' + searchValue +
                            ...
                            },
                            {
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('machinery/machinery/export/excel') }}" +
                                        '?search=' + searchValue +
                                        '&machinerytype=' + machinerytype +
                                        '&location=' + location +
                                        '&status=' + status;
            ...
            $(document).on('click', '.StatusChange', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('machinery/machinery/status') }}",
                            type: 'post',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                    .attr('content')
            ...
            $(document).on('click', '.recordDelete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('machinery/machinery/delete') }}",
                            type: 'post',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                    .attr('content')
