                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        ...
                        <div class="card-body">
                            ...
                            <form class="" id="incident_add" novalidate method="POST" enctype="multipart/form-data"
                                action="{{ admin_url('incident/notification/add/submit') }}">
                                ...
                                <div class=" border rounded ">
                                                    ...
                                                    <div class="row content-block-row">
                                                        ...
                                                        <div class="col-md-4 form-input">
                                                            ...
                                                            <div class="input-group date">
                                                                <input type="text" class="form-control todaymaxdatepicker"
                                                ...
                                                <div class="row">
                                                    <div class="col-md-4 form-input">
                                                        <label for="date_informed" class="form-label require">Date
                                                            Informed</label>
                                                        <div class="input-group date">
                                                            <input type="text" class="form-control alldatepicker" required
                                    ...
                                    <div class="content-block">
                                        ...
                                        <div class="card-header card-header-inner mt-3 content-block-header">
                                            <h6 class="text-white">PART J : Prepared By </h6>
                                        </div>
