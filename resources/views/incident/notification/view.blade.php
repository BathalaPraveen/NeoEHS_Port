                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div>
                                                    <input class="othersshow" data-id="injuries_staff_div"
                                                        ...
                                                        name="injuries[staff][value]" value="YES" id="injuries_staff">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    @foreach (range(1, 5) as $range)
                                                                        <td for=""> <input type="radio"
                                                                                ...
                                                                                id="incidentclassification1_{{ encryptId($incidentclassification->id) }}_{{ $range }}"
                                                                                value="{{ $range }}">
                                                                            <label
                                                                                for="incidentclassification1_{{ encryptId($incidentclassification->id) }}_{{ $range }}">
                                                                                {{ $range }}</label>
                                                                        </td>
                                                                    @endforeach
                                                                </tr>
                                ...
                                @if (
                                    ...
                                    <div class="content-block">
                                        ...
                                        <form class="" id="incident_approve" novalidate method="POST"
                                            ...
                                            action="{{ admin_url('incident/notification/approvereject/submit') }}">
                                            @csrf
