                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Inspection Checklist Edit</li>
                        </ol>
                    </nav>
                </div>
                        ...
                        <div class="card-body">
                            <div class="d-lg-flex align-items-center gap-3">
                                ...
                                <div class="position-relative">
                                    <h5 class="card-title">Inspection Checklist Edit</h5>
                                </div>
                                <div class="ms-auto">
                            ...
                            <div>
                                <form action="{{ admin_url('inspection/master/checklistcategory/edit/submit') }}"
                                            ...
                                            <div class="col-sm-4 form-input">
                                                <select name="inspectiontype" class="select2 form-control"
                                                    ...
                                                    @foreach ($inspectiontypeList as $inspectiontype)
                                                        <option @if ($category->inspectiontype_id == $inspectiontype->id) selected @endif
                                            ...
                                            <div class="itemlist">
                                                <div class="row g-3  pt-1 mb-1">
                                                    <div class="col-md-11 form-input">
                                                        <input type="hidden" name="itemlist[{{ $i }}][id]" id="itemlistid_{{ $i }}" value="{{ encryptId($item->id) }}">
                                                        <input type="text" name="itemlist[{{ $i }}][item]"
                                                            data-error="Please enter Checklist Item" id="itemlist_{{ $i }}"
