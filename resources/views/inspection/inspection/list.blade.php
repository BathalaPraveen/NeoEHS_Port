                ...
                <div class="">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 p-0">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">HSSE Inspection</li>
                ...
                <div class="card-body">
                    <div class="d-lg-flex align-items-center gap-3">
                        ...
                        <div class="ms-auto">
                            ...
                            <a href="{{ admin_url('inspection/inspection/create') }}" class="btn btn-primary">
                                New
                            </a>
                        </div>
                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 form-input">
                                            ...
                                            <select name="inspectiontype" id="inspectiontype" class="form-control select2"
                                                ...
                                                @foreach ($inspectiontypeDetails as $type)
                                                <option value="{{ encryptId($type->id) }}">
                                                    {{ $type->inspectiontype_name }}</option>
                                            @endforeach
                                            </select>
                                        </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('.datatable-list').DataTable({
                ...
                "ordering": false,
                ajax: {
                    url: "{{ admin_url('inspection/inspection/list') }}",
                    type: 'POST',
                    headers: {
                        ...
                        buttons: [{
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('inspection/inspection/export/pdf') }}" +
                                        '?search=' + searchValue +
                            ...
                            },
                            {
                                ...
                                action: function(e, dt, button, config) {
                                    ...
                                    window.location.href =
                                        "{{ admin_url('inspection/inspection/export/excel') }}" +
                                        '?search=' + searchValue +
                                        '&inspectiontype=' + inspectiontype +
                                        '&location=' + location +
                                        '&status=' + status;
            ...
            $(document).on('click', '.StatusChange', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('inspection/inspection/status') }}",
                            type: 'post',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                    .attr('content')
            ...
            $(document).on('click', '.recordDelete', function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            url: "{{ admin_url('inspection/inspection/delete') }}",
                            type: 'post',
                            headers: {
                                'X-CSRF-TOKEN': $('meta[name="csrf-token"]')
                                    .attr('content')
