...
class ImportEmployee implements ToCollection, WithChunkReading, ShouldQueue, WithStartRow
{
    ...
    public function collection(Collection $rows)
    {
        ...
        foreach ($rows as $row) {
            ...
            if ($i == 1) {
                ...
                if (count($row) >= 13) {
                    ...
                    if (
                        ...
                        $insert_id = DB::table('admin_upload_log_error')->insert($error_data_1);
                        $i++;
                        break;
                    }
                    $i++;
            ...
            if ($row['0'] == '') {
                ...
                $insert_id = DB::table('admin_upload_log_error')->insert($cond_error_data);
                $i++;
                continue;
            }
