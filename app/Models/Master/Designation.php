...
class Designation extends Model
{
    ...
    {
        static::addGlobalScope(new TrashScope('master_designation'));

        static::created(function ($model) {

            $uniqueId = 'DES-' . str_pad($model->id, 5, '0', STR_PAD_LEFT);
            $model->update(['designation_id' => $uniqueId]);
        });
    }
}
