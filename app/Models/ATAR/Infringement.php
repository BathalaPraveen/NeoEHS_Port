...
class Infringement extends Model
{
    ...
    protected $table = 'atar_master_ssds_infringement';
    ...
    public function store()
    {
        ...
        $insert_array = array(
            'infringement_no' => $request->infringement_no,
            'type_of_infringement' => $request->type_of_infringement,
            'created_by' => Auth::id()
        );
    ...
    public function ajaxList($useeId = '')
    {
        ...
        $query = $this->select('atar_master_ssds_infringement.*',  'atar_master_zefa_rules.zefa_rule')
            ->leftJoin('atar_master_zefa_rules', 'atar_master_ssds_infringement.zefa_rule', '=', 'atar_master_zefa_rules.id');

        if ($useeId != '') {
            $query = $query->where('atar_master_ssds_infringement.atar_type', $useeId);
        }
    ...
    {
        static::addGlobalScope(new TrashScope('atar_master_ssds_infringement'));
    }
}
