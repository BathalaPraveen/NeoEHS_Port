...
class PTWActivity extends Model
{
    use  HasFactory;


    protected $table = 'ptw_master_activity';
    ...
    public function list()
    {
        ...
        $query = $this->select('ptw_master_activity.*');
    ...
    {
        static::addGlobalScope(new TrashScope('ptw_master_activity'));
