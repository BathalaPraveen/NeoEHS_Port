    ...
    public function list()
    {
        ...
        if ($request->search['value'] != null || $request->search['value'] != '') {
            ...
            $query->where(function ($query) use ($search) {
                ...
                $query->orWhere('ptw_master_item.item_name', 'LIKE', '%' . $search . '%');
                $query->orWhere('ptw_master_activity.activity_name', 'LIKE', '%' . $search . '%');
                $query->orWhere('ptw_master_category.category_name', 'LIKE', '%' . $search . '%');
            });
        }
