...
class MachineryType extends Model
{
    ...
    protected $table = 'machinery_master_typeofmachinery';
    ...
    public function store()
    {
        ...
        $insert_array = array(
            ...
            'machinery_description' => $request->machinery_description,
            'created_by' => Auth::id()
        );
    ...
    {
        static::addGlobalScope(new TrashScope('machinery_master_typeofmachinery'));
    }
}
