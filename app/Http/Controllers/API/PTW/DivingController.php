...
class DivingController extends BaseController
{
    /**
     * UAUC api
     *
    ...
    public function list(Request $request)
    {
        ...
        if (Auth::user()) {
            ...
            $ptw_list_array = $this->diving->select('ptw_sub_permit_diving.*', 'master_location.location_name', 'users.name');
            $ptw_list_array = $ptw_list_array->leftJoin('master_location', 'ptw_sub_permit_diving.location', '=', 'master_location.id');
            $ptw_list_array = $ptw_list_array->leftJoin('users', 'ptw_sub_permit_diving.created_by', '=', 'users.id');
            ...
            if (CheckUserRole(ROLE_CONTRACTORADMIN)) {
                ...
                $ptw_list_array = $ptw_list_array->where('ptw_sub_permit_diving.created_by', Auth::id());
            }
            ...
            return $this->sendResponse($success, 'Diving PTW Details');
        } else {
    ...
    public function view(Request $request)
    {
        try {
            ...
            if (Auth::user()) {
                ...
                $diving = $this->diving->selectOne($id);

                $divingDetails =    $this->general->divingView($diving->ptw_id);
