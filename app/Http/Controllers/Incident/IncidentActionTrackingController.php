...
class IncidentActionTrackingController extends Controller
{
    ...
    public function index(Request $request)
    {
                ...
                try {
                    ...
                    $datatables = Datatables::of($data['data'])
                        ...
                        ->addColumn('action', function ($row) {
                            $btn = '';
                            $btn  = '<a href="' . admin_url('incident/actiontracking/view/' . encryptId($row->id)) . '"   class="" title="View"><i class="fa-solid fa-eye"></i></a> ';

                            if ($row->incident_status == INCIDENT_NOTIFICATION_STATUS_GHSE_PENDING) {
                                $btn .= '<a href="' . admin_url('incident/actiontracking/approvereject/' . encryptId($row->id)) . '"   class="" title="Approve / Reject"><i class="fa-solid fa-check-to-slot"></i></a> ';
                            }

                            if ($row->incident_status == INCIDENT_NOTIFICATION_STATUS_GHSE_REJECTED) {
                                $btn .= '<a href="' . admin_url('incident/actiontracking/edit/' . encryptId($row->id)) . '"   class="" title="Edit"><i class="fa-solid fa-edit"></i></a> ';
                            }
        ...
        return view('incident.actiontracking.list', $data);
    }
    ...
    public function ExportPdf(Request $request)
    {
        try {
            ...
            $view = view('incident.actiontracking.pdf', $data);
            $html = $view->render();
    ...
    public function ExportViewPdf(Request $request)
    {
        ...
        try {
            ...
            $view = view('incident.actiontracking.pdf.Incident', $data);
            $html = $view->render();
