...
class IncidentCategoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if (Auth::check()) {
            if ($request->ajax()) {
                try {
                    ...
                    $data =  $this->incidentcategory->list();
        ...
        return view('incident.master.category.list', $data);
    }
    ...
    public function View(Request $request)
    {
        try {
            ...
            if (Auth::check()) {
                $company = $this->incidentcategory->selectOne($id);
    ...
    public function Edit(Request $request)
    {
        try {
            ...
            $category = $this->incidentcategory->selectOne($id);
            $data = array(
                'category' => $category,
            );
    ...
    public function Update(Request $request)
    {
        try {
            ...
            $this->incidentcategory->updates($id);
    ...
    public function StatusChange(Request $request)
    {
        ...
        try {
            ...
            $this->incidentcategory->statuschange($id);
    ...
    public function Delete(Request $request)
    {
        try {
            ...
            $this->incidentcategory->deleterecord($id);
    ...
    public function ExportExcel(Request $request)
    {
        ...
        try {
            ...
            $allData = $this->incidentcategory->exportdata();
    ...
    public function list(Request $request){
        ...
        $activity = $this->incidentcategory->ajaxList($activityid);
